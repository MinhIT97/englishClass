<x-app-layout>
    ...
    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 2rem; margin-bottom: 4rem">
        ...
        <div class="card" style="position: relative; overflow: hidden; padding: 2rem; transition: transform 0.3s;" onmouseover="this.style.transform='translateY(-5px)'" onmouseout="this.style.transform='translateY(0)'">
            ...
            <h3 style="margin-bottom: 0.5rem">IELTS Full Simulation #01</h3>
            ...
            <div style="display: flex; align-items: center; justify-content: space-between">
                ...
                <button class="btn btn-primary" style="padding: 0.6rem 1.5rem; border-radius: 50px;">Start Full Test</button>
            </div>
        </div>
        ...
        <div class="card" style="position: relative; overflow: hidden; padding: 2rem; opacity: 0.7; border-style: dashed">
            ...
            <h3 style="margin-bottom: 0.5rem">IELTS Full Simulation #02</h3>
            ...
            <div style="display: flex; align-items: center; justify-content: flex-end">
                <button class="btn btn-outline" disabled style="padding: 0.6rem 1.5rem; border-radius: 50px; cursor: not-allowed">Locked</button>
            </div>
        </div>
    </div>
