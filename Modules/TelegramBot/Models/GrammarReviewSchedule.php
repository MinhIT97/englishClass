...
class GrammarReviewSchedule extends Model
{
    protected $table = 'tgb_grammar_review_schedules';
    ...
    public function grammarEntry(): BelongsTo
    {
        return $this->belongsTo(GrammarEntry::class, 'grammar_entry_id');
    }
